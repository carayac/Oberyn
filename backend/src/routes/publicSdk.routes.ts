...
publicSdkRoutes.post("/payguard/config", asyncHandler(sdkController.payguardConfig));
publicSdkRoutes.post("/payguard/payment-requests", asyncHandler(sdkController.createPayGuardPaymentRequest));
...
publicSdkRoutes.post("/v1/payguard/config", asyncHandler(sdkController.payguardConfig));
publicSdkRoutes.post("/v1/payguard/payment-requests", asyncHandler(sdkController.createPayGuardPaymentRequest));
