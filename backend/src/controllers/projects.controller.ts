...
export const projectsController = {
  ...
  update: async (req: Request, res: Response) => res.json(ok(await projectsService.update(req.params.projectId, req.body, res.locals.organizationId))),
  remove: async (req: Request, res: Response) => res.json(ok(await projectsService.remove(req.params.projectId, res.locals.organizationId))),
};
