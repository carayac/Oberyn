...
export const projectsController = {
  list: async (_req: Request, res: Response) => res.json(ok(await projectsService.list())),
  create: async (req: Request, res: Response) => res.status(201).json(created(await projectsService.create(req.body))),
