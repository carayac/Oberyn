...
export const exceptionsController = {
  list: async (req: Request, res: Response) => res.json(ok(await exceptionsService.list(req.params.projectId, typeof req.query.type === "string" ? req.query.type : undefined))),
